...
public class MaxwellIntegrationTest extends MaxwellTestWithIsolatedServer {
	...
	public void testDDLTableBlacklist() throws Exception {
		//Moved the query into the blacklistSQLDDL list, fixed the error.
	...
	public void testMyISAMCommit() throws Exception {
		String sql[] = {
				...
				"CREATE TABLE IF NOT EXISTS myisam_test ( id int ) engine=myisam",
	...
	public void testLowerCasingSensitivity() throws Exception {
		...
		String[] sql = {
			"DROP TABLE IF EXISTS `test`.`TOOTOOTWEE`",
			"CREATE TABLE IF NOT EXISTS `test`.`TOOTOOTWEE` ( id int )",
	...
	public void testJdbcConnectionOptions() throws Exception {
		...
		assertEquals(config.maxwellMysql.getConnectionURI(), 
				"jdbc:mysql://localhost:3306?useCursorFetch=true&zeroDateTimeBehavior=convertToNull&interactiveClient=true&netTimeoutForStreamingResults=123&profileSQL=true");
