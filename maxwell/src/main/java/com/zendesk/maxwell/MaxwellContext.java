...
public class MaxwellContext {
	...
	public String getSecertKey() {
		return config.secertKey;
	}
	public Boolean getuseEncryption() { return config.useEncryption; }
	public Boolean getRemoveNonAscii() { return config.removeNonAscii; }
	public Integer getTrimString() { return config.trimString; }
	public Boolean getIncludeNulls() { return config.includeNulls; }
