...
public class Maxwell {
	...
	public static Integer trimString;
	public static Boolean removeNonAscii;
	public static Boolean includeNulls;
	...
	private void run(String[] argv) throws Exception {
		...
		// Dave - Added for Encryption
		useEncryption = this.context.getuseEncryption();
		encryptionKey = this.context.getEncryptionKey();
		secertKey = this.context.getSecertKey();
		trimString = this.context.getTrimString();
		removeNonAscii = this.context.getRemoveNonAscii();
		includeNulls = this.context.getIncludeNulls();
