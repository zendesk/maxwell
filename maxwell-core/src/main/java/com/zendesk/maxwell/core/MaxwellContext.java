...
public class MaxwellContext {
	...
	public MaxwellContext(MaxwellConfig config, MetricRegistry metricRegistry) throws SQLException, URISyntaxException {
		this.config = config;
		...
		if (this.config.replayModeEnabled) {
	...
	public boolean isReplayMode() {
		return this.config.replayModeEnabled;
	}
