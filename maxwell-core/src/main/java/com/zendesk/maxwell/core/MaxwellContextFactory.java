...
public class MaxwellContextFactory {
	...
	@Autowired
	public MaxwellContextFactory(ProducerInitialization producerInitialization, MetricRegistry metricRegistry, List<ContextStartListener> contextStartListeners) {
