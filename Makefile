...
ADDITIONAL_PACKAGED_KAFKA_09=0.9.0.1
...
target/.java: $(ANTLR_OUTPUT) $(JAVA_SOURCE)
	...
	build/maven_fetcher -f org.apache.kafka/kafka-clients/$(ADDITIONAL_PACKAGED_KAFKA_09) --skip-dependencies -o target/dependency >/dev/null
...
package-tar:
	...
	build/maven_fetcher -f org.apache.kafka/kafka-clients/$(ADDITIONAL_PACKAGED_KAFKA_09) --skip-dependencies -o target/dependency-build >/dev/null
