...
string_type locals [Boolean utf8 = false]:
      (NATIONAL {$utf8=true;})?
      col_type=(CHAR | CHARACTER | VARCHAR) length?  (column_options | string_column_options | BYTE)*
    | (NATIONAL {$utf8=true;})?
      (CHARACTER|CHAR) col_type=VARYING length (string_column_options | column_options | BYTE)*
    ...
    | col_type=(TINYTEXT | MEDIUMTEXT | LONGTEXT) (column_options | string_column_options | BYTE)*
    | col_type=TEXT length? (column_options | string_column_options | BYTE)*
    | long_flag col_type=(VARCHAR | BINARY) (column_options | string_column_options)*
    | long_flag col_type=VARBINARY column_options*
    | col_type=LONG (column_options | string_column_options | BYTE)*
    ;
