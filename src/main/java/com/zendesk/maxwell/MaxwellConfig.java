...
public class MaxwellConfig extends AbstractConfig {
	...
	public String jsonMappingConfig;
	...
	protected OptionParser buildOptionParser() {
		...
		parser.accepts( "kafka_version", "switch to kafka 0.8 or 0.10 producer (from 0.9)");
		...
		parser.accepts( "json_mapping_config", "some awesome doc").withOptionalArg(); // TODO
	...
	private void setup(OptionSet options, Properties properties) {
		...
		this.jsonMappingConfig	    = fetchOption("json_mapping_config", options, properties, null);
