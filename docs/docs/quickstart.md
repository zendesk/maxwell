# Download
***
- Download binary distro: [https://github.com/zendesk/maxwell/releases/download/v1.37.2/maxwell-1.37.2.tar.gz](https://github.com/zendesk/maxwell/releases/download/v1.37.2/maxwell-1.37.2.tar.gz)
- Sources and bug tracking is available on github: [https://github.com/zendesk/maxwell](https://github.com/zendesk/maxwell)

**curl**:
```
curl -sLo - https://github.com/zendesk/maxwell/releases/download/v1.37.2/maxwell-1.37.2.tar.gz \
       | tar zxvf -
cd maxwell-1.37.2
```
