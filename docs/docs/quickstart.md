# Download
***
- Download binary distro: [https://github.com/zendesk/maxwell/releases/download/v1.40.6/maxwell-1.40.6.tar.gz](https://github.com/zendesk/maxwell/releases/download/v1.40.6/maxwell-1.40.6.tar.gz)
- Sources and bug tracking is available on github: [https://github.com/zendesk/maxwell](https://github.com/zendesk/maxwell)

**curl**:
```
curl -sLo - https://github.com/zendesk/maxwell/releases/download/v1.40.6/maxwell-1.40.6.tar.gz \
       | tar zxvf -
cd maxwell-1.40.6
```
