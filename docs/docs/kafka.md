...
The HASH_STRING may be (_database_, _table_, _primary_key_as_string_).  The default HASH_STRING is the _database_. The partitioning field can be configured using the `kafka_partition_by` option.    
